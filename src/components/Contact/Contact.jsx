  ...
  return (
    <div  data-aos="zoom-in"  className='dark:bg-black dark:text-white py-14'>
      <div className="container">
        ...
        sm:grid-cols-3 gap-6 bg-gray-800 py-8 px-6'>
            <div className='col-span-2 space-y-3'>
                ...
                <p className='text-gray-400'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                    Vel soluta delectus quidem ad, ea qui eum ratione quasi 
                    corporis impedit minus quis explicabo temporibus ullam 
                    quos, neque laboriosam animi. Odio?</p>
            </div>
            <div className='grid place-items-center'>
                <a href="#"
                className='inline-block font-semibold py-2 px-6
                bg-primary text-white rounded-lg tracking-wider uppercase
